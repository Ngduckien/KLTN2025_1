            ...
            if (!currentUser.isEmpty()) {
                ...
                if (user != null) {
                    ...
                    if (user.getNgaysinh() == null) {
                        txtNgaySinh.setText("Ngày sinh: Chưa có");
                    } else {
                        txtNgaySinh.setText("Ngày sinh: " + user.getNgaysinh().toString());
                        Log.d("Test giá trị ngày sinh", user.getNgaysinhFormat()+"Giá trị khác"+user.getNgaysinh());
                    }
